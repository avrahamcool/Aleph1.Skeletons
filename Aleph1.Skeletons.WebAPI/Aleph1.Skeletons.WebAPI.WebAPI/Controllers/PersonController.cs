...
namespace Aleph1.Skeletons.WebAPI.WebAPI.Controllers
{
    ...
    public class PersonController : ApiController
    {
        ...
        [Authenticated, Logged, HttpGet, Route("api/Person")]
        ...
        [Authenticated(Roles.Anonymous), Logged, HttpGet, Route("api/Person/Count")]
        ...
        [Authenticated, Logged, HttpGet, Route("api/Person/{ID}")]
        ...
        [Authenticated(Roles.Admin), Logged, HttpGet, Route("api/Person/SearchByName")]
        ...
        /// <returns>the person</returns>
        [Authenticated, Logged, HttpPost, Route("api/Person")]
        ...
        /// <param name="person">the person</param>
        /// <returns>the person</returns>
        [Authenticated, Logged, HttpPut, Route("api/Person/{ID}")]
        ...
        [Authenticated, Logged, HttpDelete, Route("api/Person/{ID}")]
